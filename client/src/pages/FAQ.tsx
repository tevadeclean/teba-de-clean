  ...
  const faqs = [
      ...
      items: [
        {
          ...
          a: "公式HPまたは公式LINEからご予約いただいたお客様限定で、通常オプション of 「防カビ・抗菌コート」を無料で施工させていただきます。カビの繁殖を抑え、清潔な状態を長持ちさせます。"
        },
        {
          q: "完全分解洗浄とは何ですか？",
    ...
    },
    {
      ...
      items: [
        {
          q: "予約はどのようにすればいいですか?",
          a: "公式LINEまたは予約フォームから承っております。公式LINEからですと画像のやり取りなどもしやすく便利ですので、基本的にはLINEからのご予約をおすすめしております。法人様や、メールでのやり取りをご希望の場合は、お問い合わせフォームからご連絡ください。"
        },
        {
          q: "対応エリアはどこですか?",
          a: "那覇市、浦添市、宜野湾市、沖縄市、うるま市、糸満市、豊見城市、南城市をはじめとする沖縄本島内の各市町村に対応しております。離島についても、団体様（複数台施工）などの場合は対応可能ですので、まずはお気軽にご相談ください。"
        },
        {
          q: "土日祝日も対応していますか?",
          a: "はい、土日祝日も対応しております。受付時間は、平日は9:00〜17:00、土日祝日は9:00〜14:00となっておりますが、時間外の作業も柔軟に対応可能です。まずはお気軽にご相談ください。"
        }
      ]
    }
  ];
